<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyMasterPage.Master" AutoEventWireup="true" CodeBehind="MyRoleManagement.aspx.cs" Inherits="ASPdotNetProject_Iqbal.ContentPages.MyRoleManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" runat="server">
    ...
    (Only user Associated with the admin role can access this page)
    <br />
    ...
    <div class="row">
        <div class="col-sm-12 table-responsive">
            ...
            <asp:GridView ID="grdUsers" runat="server" DataKeyNames="Id"
                ...
                ItemType="ASPdotNetProject_Iqbal.Models.ApplicationUser" 
