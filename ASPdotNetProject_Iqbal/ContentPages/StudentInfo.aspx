<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MyMasterPage.Master" AutoEventWireup="true" CodeBehind="StudentInfo.aspx.cs" Inherits="ASPdotNetProject_Iqbal.ContentPages.StudentInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="cpMainContent" runat="server">
     <div>
        <h3>Please Provide Your Valid Information To Proceed Registration </h3>
        <br />
